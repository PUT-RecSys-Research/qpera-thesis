...
class KnowledgeGraph:
    ...
    def _add_relation_edges(
        ...
        for head_idx, tail_idx in relation_data:
            if self._validate_edge_indices(
                head_idx, tail_idx, head_vocab_size, tail_vocab_size, relation_name
            ):
    ...
    def _entities_exist(self, etype1: str, eid1: int, etype2: str, eid2: int) -> bool:
        ...
        return (etype1 in self.G and etype2 in self.G and 
