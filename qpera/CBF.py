...
def cbf_experiment_loop(
    ...
    # Initialize TF-IDF recommender with BERT tokenization
    ...
    # Filter out items already in training set to ensure novel recommendations
    ...
    # Get top recommendation per user for certain metrics
